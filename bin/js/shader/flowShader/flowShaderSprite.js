...
*/
var flowShaderSprite = /** @class */ (function (_super) {
    __extends(flowShaderSprite, _super);
    function flowShaderSprite() {
    ...
    ib 顶点索引数组
    */
    flowShaderSprite.prototype.init = function (texture) {
    ...
    //重写渲染函数
    flowShaderSprite.prototype.customRender = function (context, x, y) {
        //流光
        this.shaderValue.flowTween += 0.05;
        if (this.shaderValue.flowTween > Math.PI * 2) {
            this.shaderValue.flowTween = 0.0;
        }
        context.ctx.setIBVB(x, y, (this.iBuffer), (this.vBuffer), this.iNum, null, flowShader.shader, this.shaderValue, 0, 0);
    };
    flowShaderSprite.prototype.updateVBData = function () {
    ...
    return flowShaderSprite;
}(Laya.Sprite));
//# sourceMappingURL=flowShaderSprite.js.map